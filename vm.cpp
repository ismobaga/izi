...
#define BINARY_OP(valueType, op) \
  ...
  for (;;) {
    ...
    switch (instruction = READ_BYTE()) {
      ...
      case GREATER:  BINARY_OP(BOOL_VAL, >); break;
      case LESS:     BINARY_OP(BOOL_VAL, <); break;
      case ADD:      
      {
      ...
      case SUBTRACT: BINARY_OP(NUMBER_VAL, -); break;
      case MULTIPLY: BINARY_OP(NUMBER_VAL, *); break;
      case DIVIDE:   BINARY_OP(NUMBER_VAL, /); break;
      case NOT: push(BOOL_VAL(isFalsey(pop()))); break;
      case NEGATE:  
      if (!IS_NUMBER(peek(0))) {
